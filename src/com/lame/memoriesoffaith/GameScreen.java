...
import com.lame.framework.Game;
import com.lame.framework.Graphics;
import com.lame.framework.Image;
import com.lame.framework.Screen;
...
public class GameScreen extends Screen {
	...
	public GameScreen(Game game) {
		...
		bg1 = new Background(0, -640);
		bg2 = new Background(0, -160);
		bg3 = new Background(0, 320);
		bg4 = new Background(0, 800);
		robot = new Robot();
		...
		for (int i = 0; i < len; i++) {
			...
			if (event.type == TouchEvent.TOUCH_DRAGGED) {
				...
				if (event.x > robot.getCenterX()) {
					// Move right.
					if (event.x < robot.getCenterX() + 10 && event.x > robot.getCenterX () - 10 && event.y < robot.getCenterY() + 10 && event.y > robot.getCenterY() - 10)
					{
						robot.stopRight();
						robot.stopUp();
						robot.stopDown();
	...
	public void paint(float deltaTime) {
		...
		g.drawImage(Assets.background, bg1.getBgX(), bg1.getBgY()-160);
		g.drawImage(Assets.background, bg2.getBgX(), bg2.getBgY()-320);
		g.drawImage(Assets.background, bg3.getBgX(), bg3.getBgY()-320);
		g.drawImage(Assets.background, bg4.getBgX(), bg4.getBgY()-320);
		paintTiles(g);
